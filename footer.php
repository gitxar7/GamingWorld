        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto">
                    <h5 class="text-uppercase  text-warning ">GamingWorld</h5>
                    <p>Here we are the GamingWorld.lk&trade; to support you for accomplish your desire by selling high quality games & gaming products.</p>
                    <p class="text-black fw-bold"> by HSS◆AR7</p>
                </div>

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-4">
                    <p>Copyright &copy; 2022 NewTech All Rights Reserved</p>
                </div>
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto">
                    ...
                    <p><i class="bi bi-at"></i> gamingworld@gmail.com</p>
